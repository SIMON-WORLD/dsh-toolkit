...
| 包 | 解决痛点 | 状态 |
|---|---|---|
| [`packages/dsh-doctor`](packages/dsh-doctor) | 环境问题无统一诊断（#649/#1719 46 评论） | 🟢 v0.1 可用 |
| [`packages/dsh-at-file`](packages/dsh-at-file) | 不能 @ 选择文件（12+ 帖） | 🟡 骨架 |
| [`packages/dsh-cost-dashboard`](packages/dsh-cost-dashboard) | 费用无感知（#500/#318 + 峰谷涨价） | 🟡 骨架 |
| [`packages/dsh-vision-bridge`](packages/dsh-vision-bridge) | 纯文本模型不能看图（#474 根因） | 🟡 骨架 |
| [`docs/`](docs) | 学习成本高、文档不全（P150-P155） | 🟢 知识库 |
